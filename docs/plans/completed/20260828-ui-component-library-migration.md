> 历史边界：本文件记录已结束的组件库迁移，不作为当前执行或项目状态真源；长期组件与视觉规则以 [DESIGN](../../DESIGN.md) 为准，当前状态见 [ROADMAP](../../ROADMAP.md)。

# 计划 66 — Site UI 组件库引入与 PWA 迁移

**技术状态：Phase 0–5 的实现当前有效；Phase 3 已按新模型完成收口；Phase 5 已完成（2026-09-01）**
**当前核对：2026-09-01；当前执行状态、跨计划顺序和切换门禁以 [Plan 68 — PWA UI 与自动化测试交付路线](20260829-pwa-ui-quality-roadmap.md) 为唯一真源**
**范围：`site/` 前端，优先 PWA**
