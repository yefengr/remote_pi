...
> 迁移说明：本文件保存已确认、尚未实施的目标主题设计，不描述当前 PWA 实现；当前设计基线见 [DESIGN](../../DESIGN.md)，项目状态见 [ROADMAP](../../ROADMAP.md)。
...
可评审原型（已确认）：[prototypes/20260830-pwa-theme.html](../../prototypes/20260830-pwa-theme.html)
