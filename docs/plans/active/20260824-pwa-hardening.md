...
基于：`docs/plans/active/20260822-pwa-scope.md`、`docs/plans/active/20260822-pwa-architecture.md`

本文件记录 Remote Pi PWA 规范化与 Service Worker 加固的确认结果。它补充并在 PWA Service Worker 方案上取代 `docs/plans/active/20260822-pwa-architecture.md` 中的“小型自定义 Service Worker”方案；不修改 Relay、`pi-extension` 或消息历史同步协议。
